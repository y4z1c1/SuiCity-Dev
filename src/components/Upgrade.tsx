...
const Upgrade = ({
  ...
  const upgrade = useCallback(async () => {
    try {
      ...
      console.log("Upgrade with SUI:", costs.sui * Number(MIST_PER_SUI));
      ...
      if (costs.sui > 0) {
        transactionBlock.moveCall({
          ...
          arguments: [
            ...
            transactionBlock.pure.u64(buildingType),
            coinWithBalance({ balance: 1 }),
        ...
        if (useSui) {
          ...
          transactionBlock.moveCall({
            ...
            arguments: [
              ...
              transactionBlock.object(ADDRESSES.GAME),
              transactionBlock.pure.u8(buildingType),
